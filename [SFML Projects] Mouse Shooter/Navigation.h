...
public:
	...
	void updateSeedHoverOnField(UI& ui, Mouse& mouse, Timer& timer, FieldManager& f_Manager, ShopEngine& shop_e);
	void updateUI(UI& ui, Mouse& mouse, Timer& timer);
	void update(Mouse& mouse, UI& ui, Timer& timer, std::vector<sf::Texture*>& textures, FieldManager& f_Manager, ShopEngine& shop_e);
