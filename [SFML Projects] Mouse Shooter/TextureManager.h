...
public:
	...
	enum keys{lights = 0, sceneries, crops, seeds, fields, ui, shop_icons, build_icons};
	//Keylist
	//{lights = 0, sceneries = 1, crops = 2, seeds = 3, fields = 4, ui = 5, shop_icons = 6, build_icons = 7}
